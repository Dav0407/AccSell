package com.igriss.AkkSell.documentation;
...
@OpenAPIDefinition(
        info = @Info(
                ...
                description = "Description for AXEL account marketplace REST application",
                title = "AXEL documentation - Davron Normamatov",
                version = "1.0.3",
                license = @License(
                        name = "License name",
